...
const ProductInfo = ({ rating, product, style, onSale, scroll }) => {
  if (onSale) {
    return (
      <ul>
        <li data-testid="product-info-rating-reviews" className="product-info-rating-reviews">
          <Stars rating={rating} />
          <div data-testid="read-all-reviews" className="read-all-reviews" onClick={() => scroll()}>Read All Reviews</div>
        </li>
