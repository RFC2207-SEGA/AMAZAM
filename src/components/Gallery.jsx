  ...
  render () {
    return (
      <div>
        ...
        <FullscreenModal show={this.state.showModal} photo={this.props.style.photos[this.props.index - 1]} index={this.props.index - 1} last={this.props.style.photos.length - 1} toggleModal={this.triggerModal.bind(this)} next={this.props.movePhoto} prev={this.props.movePhoto} zoom={this.modalHover.bind(this)} photos={this.props.style.photos} onClick={this.props.movePhoto}/>
      </div>
    )
  }
}
